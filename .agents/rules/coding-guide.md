...
- **Meaningful Comments Only**: Do not write random or redundant comments (e.g., `// parse string` above `parseString()`). Code should be self-documenting. Only comment non-obvious "why" decisions.
